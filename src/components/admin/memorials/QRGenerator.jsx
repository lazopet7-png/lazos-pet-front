                ...
                {!qrData ? (
                  <div className="text-center py-6">
                    ...
                    <button
                      onClick={generateQR}
                      disabled={generating}
                      className="inline-flex items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-pet-700 hover:bg-pet-800 disabled:opacity-50"
                    >
                      {generating ? (
                        <>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="pt-4 space-y-3">
                      <button
                        onClick={handlePrint}
                        className="w-full inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-pet-700 hover:bg-pet-800"
                      >
                        <svg className="-ml-1 mr-2 h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
